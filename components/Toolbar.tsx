...
import { Plus, Info, Download, History, Upload, BoxSelect, Eye, Palette, Grid3X3, Circle, CircleOff, LogOut } from 'lucide-react';
    ...
    <div className="fixed bottom-6 left-1/2 transform -translate-x-1/2 bg-white/90 backdrop-blur-md border border-slate-200 shadow-xl rounded-2xl px-4 py-2 flex items-center gap-2 z-50">
      ...
      <div className="flex items-center gap-2 pl-1">
        {user ? (
          ...
          <button
            onClick={onLogin}
            className="px-4 py-2 bg-white border border-slate-200 rounded-xl text-sm font-medium text-slate-700 hover:bg-slate-50 hover:border-blue-200 hover:text-blue-600 transition-all shadow-sm flex items-center gap-2"
          >
